...
const Data = () => {
  return (
    <div className="home__data block block-paddings info_detail" id="about">
      <div className="box_wraper">
        <i className="bx bx-user-circle" style={{ fontSize: 24 }}></i>
      </div>
      
      <h2 className="ho_h1_title">
        Hello{" "}
        <span className="hand-wave-wrapper">
          <svg
            width="36"
            height="36"
            viewBox="0 0 48 48"
      ...
      <p className="home__description">
        I'm Hardik Singh, a dedicated PHP & WordPress Developer and Frontend Specialist with 3+ years of hands-on experience building high-conversion e-commerce solutions, bespoke plugins, REST API integrations, and intuitive web interfaces.
      </p>
