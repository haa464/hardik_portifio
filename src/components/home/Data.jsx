...
const Data = () => {
  return (
    ...
    <div className="home__data block block-paddings info_detail" id='about'>
        <div className="box_wraper"><i className="bx bx-user-circle" style={{fontSize: 24}}></i></div>
        <h2 className="ho_h1_title">Hello 
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm Hardik Singh, a dedicated frontend developer with a passion for creating engaging and intuitive user interfaces. With 2+ years of hands-on experience, I specialise in turning creative ideas into functional and visually appealing websites and web applications.</p>

        <span>
        <i className="bx bxs-edit-location" style={{fontSize: 14}}> Based in Mumbai, Maharashtra, India.</i>
        </span>
    </div>
    </>
  )
